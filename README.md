...
// Will be added soon
```
Link to the problem number 7 for testing: [Test out the solution here](https://app.codesignal.com/arcade/intro/level-2/2mxbGwLzvkTCKAJMG)
...
```
Link to the problem number 8 for testing: [Test out the solution here](https://app.codesignal.com/arcade/intro/level-2/xskq4ZxLyqQMCLshr)
...
```
Link to the problem number 9 for testing: [Test out the solution here](https://app.codesignal.com/arcade/intro/level-3/fzsCQGYbxaEcTr2bL)
...
```
Link to the problem number 10 for testing: [Test out the solution here](https://app.codesignal.com/arcade/intro/level-3/JKKuHJknZNj4YGL32)
...
```
Link to the problem number 11 for testing: [Test out the solution here](https://app.codesignal.com/arcade/intro/level-3/3AdBC97QNuhF6RwsQ)
...
```
Link to the problem number 12 for testing: [Test out the solution here](https://app.codesignal.com/arcade/intro/level-3/D6qmdBL2NYz49XHwM)
